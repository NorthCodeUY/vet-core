  ...
  return (
    <div 
      ...
      className={`
        ...
        /* --- Dimensiones --- */
        h-full                       /* Altura total */ 
        w-full                       /* Ocupa el 100% de la celda de la grilla */
        min-w-0                      /* CRÍTICO: Elimina el ancho mínimo fijo de 280px que rompía la grilla en mobile */
        p-3 sm:p-5                   /* Padding optimizado para 2 columnas en mobile y 5 en desktop */
        ...
        /* --- Estilo --- */
        rounded-[1.5rem] sm:rounded-[2rem] /* Bordes adaptables */
      ...
      {estaSeleccionado && (
        <div className={`
          ...
          top-2 left-2 sm:top-4 sm:left-4 /* Ubicación exacta */
          z-20                         /* Por encima de la imagen */
          
          /* --- Dimensiones --- */
          flex                         /* Alineación icono-texto */
          items-center                 /* Centrado verticalmente */
          gap-1 sm:gap-2               /* Espaciado interno */
          px-2 py-1 sm:px-3 sm:py-1.5   /* Espaciado interno adaptado */
          ...
          text-xs sm:text-sm           /* Tamaño de texto ajustado para mobile */
      ...
      <img
        ...
        */
        ...
        className={`
          ...
          h-32 sm:h-48             /* Altura proporcional en mobile (32) y desktop (48) */
          
          /* --- Estilo --- */
          object-cover             /* Asegura que la imagen no se deforme */
          rounded-xl sm:rounded-2xl /* Bordes redondeados para la imagen */
        `}
      />
      ...
      <div className={`
        ...
        gap-1.5 sm:gap-2           /* Espacio entre badges */
        mt-1 sm:mt-2               /* Margen superior */
      `}>
        ...
        {producto.subcategoria?.map((sub, idx) => (
          <div key={idx} title={sub.subc_nombre} className={`
            ...
            /* --- Dimensiones --- */
            p-1 sm:p-1.5               /* Espaciado interno del icono */
            /* --- Colores --- */
      ...
      <h4 className={`
        ...
        text-base sm:text-lg       /* Ajustado para mobile */
        /* --- Dimensiones --- */
      ...
      <p className={`
        ...
        text-xs sm:text-sm          /* Tamaño de fuente ajustado */
      ...
      <div className={`
        ...
        pt-2 sm:pt-4                 /* Agrega un padding superior para separar del texto */
      ...
      `}>
        ...
        <span className={`
          ...
          text-lg sm:text-xl         /* Tamaño de fuente ajustado */
        `}>
        ...
        <div className="flex gap-1.5 sm:gap-2 items-center">
          ...
          <img
            ...
            className={`
              /* --- Dimensiones --- */
              w-6 h-6 sm:w-8 sm:h-8     /* Tamaño responsivo */
              /* --- Animación --- */
          ...
          <div
            ...
            className={`
            /* --- Posición --- */
            p-1.5 sm:p-2               /* Espaciado interno */
            cursor-pointer             /* Cursor de mano */
          ...
          `}>
            <ShoppingCart className="w-4 h-4 sm:w-4 sm:h-4 text-white" />
          </div>
        </div>
      </div>
    </div>
